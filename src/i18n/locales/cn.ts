export default {
  gameData: {
    ...
    islandTimeHint: '时间估算不包含无人岛建设、制作与采集。',
    title: '游戏缓存数据',
    version: '当前数据版本',
    ...
    reloadWarning: '将应用新数据并刷新页面。未保存的编辑与备料分配会丢失；已保存的笔记与收藏不受影响。是否继续？',
    updateReady: '新游戏数据已下载完成。',
    apply: '应用并刷新',
    later: '下次打开时应用',
    retry: '重试',
    loadingCatalog: '正在加载物品数据…',
    loadingCore: '物品已可搜索；正在准备配方与素材来源…',
    error_catalog: '物品数据加载失败，请重试。',
    error_core: '配方或素材来源尚未加载完成，备料功能暂时无法使用。请重试。',
    error_update: '当前数据仍可使用，但无法检查或下载更新。',
    islandOther: '无人岛其他来源',
    islandStage: '仅计算所选阶段，不包含前置建设或解锁需求。'
  },
  app: {
    title: '冷冻兔肉的工坊',
    subtitle: '兔肉不私藏的好笔记本'
  ...
  newNote: {
    ...
    filter: {
      open: '筛选物品',
      title: '筛选物品',
      description: '使用既有可搜索物品列表里的数据来筛选物品。',
      close: '关闭',
      keyword: '关键词',
      ilvlMin: '物品品级下限',
      ilvlMax: '物品品级上限',
      equipLevelMin: '装备等级下限',
      equipLevelMax: '装备等级上限',
      job: '职业',
      allJobs: '全部职业',
      category: '物品类型',
      clear: '清除筛选',
      resultCount: '{count} 个物品',
      ilvlShort: '品级',
      equipLevelShort: '装等',
      emptyTitle: '找不到符合条件的物品',
      emptyDescription: '可以放宽一两个筛选条件再试试。',
      cancel: '取消',
      confirm: '使用选中的物品',
      categories: {
        all: '全部',
  ...
  editor: {
    ...
    mergeDescription: '粘贴您要合并的笔记 JSON，相同物品的数量将会自动累加。',
    mergeCancel: '取消',
    mergeConfirm: '确认合并',
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: '笔记可以编辑和增减物品吗？',
        a: '笔记工作台就是为此而生。在你的笔记上找到复制 JSON 按钮，到工作台上粘贴并导入。在这里你可以增加物品、删除物品、修改数量，甚至把另一张笔记合并进来。'
      },
      {
        q: '为什么预估的市场价格看起来不准确？',
      ...
      {
        q: '市场成本策略是什么？',
        a: '市场版的价格来源是缓存，意味着你在本站看到的价格有可能因为时间差，导致前往实际购买时只剩更高价的在售商品。为了补足这种心理误差，本网站提供三种「市场成本策略」：激進（市场最低价）、平衡（市场 1/4 分位数）、保守（市场中位数），让你在参考本站列出的价格时，可以多一层防守性的价格缓冲。'
      },
      {
  ...
  marketSetupReminder: {
    title: '别忘了设置市场来源',
    description: '市场价格会依照你选择的地区与数据中心估算。开始备料前，先在这里确认市场来源是否符合你游玩的环境。',
    note: '选好市场地区与数据中心后，工坊会用这个来源估算市场价格。',
    confirm: '使用这个来源',
    later: '稍后再说'
  },
  changelog: {

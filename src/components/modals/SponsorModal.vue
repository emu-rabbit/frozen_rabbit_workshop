...
<template>
  <Transition name="modal">
    <div v-if="visible" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      <!-- Modal Container -->
      <div class="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden transform transition-all border border-soft-green-100">
        <!-- Close Button (Mobile) -->
        <button 
          @click="close"
          class="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-slate-100/80 text-slate-500 flex items-center justify-center hover:bg-slate-200 lg:hidden"
        >
        ...
        <div class="flex flex-col md:flex-row">
          ...
          <div class="md:w-5/12 bg-soft-green-50 p-8 flex flex-col justify-between border-b md:border-b-0 md:border-r border-soft-green-100">
            <div>
              <div class="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center mb-6 border border-soft-green-100">
            ...
            <div class="hidden md:block mt-8">
              <div class="flex items-center gap-2 text-soft-green-600 text-[10px] font-bold tracking-widest uppercase">
          ...
          <div class="md:w-7/12 p-8">
            ...
            <div class="space-y-4">
              ...
              <button 
                ...
                class="w-full group text-left p-5 rounded-2xl border-2 border-soft-green-100 hover:border-soft-green-400 hover:bg-soft-green-50 transition-all duration-300 relative overflow-hidden"
              >
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h3 class="font-black text-soft-green-900 group-hover:text-soft-green-800 transition-colors">
                  ...
                  <div class="ml-auto self-center opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all">
                    <i class="pi pi-chevron-right text-soft-green-500"></i>
                  </div>
                </div>
              </button>
              ...
              <button 
                ...
                class="w-full group text-left p-5 rounded-2xl border-2 border-rose-100 hover:border-rose-400 hover:bg-rose-50 transition-all duration-300 relative overflow-hidden"
              >
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    <h3 class="font-black text-slate-900 group-hover:text-rose-900 transition-colors">
                  ...
                  <div class="ml-auto self-center opacity-0 group-hover:opacity-100 transform translate-x-2 group-hover:translate-x-0 transition-all">
                    <i class="pi pi-chevron-right text-rose-500"></i>
                  </div>
                </div>
              </button>
            </div>

            <p class="text-[10px] text-center text-slate-400 mt-8 font-medium italic">

...
export const DEFAULT_MARKET_REGION = '繁中服'
export const DEFAULT_MARKET_DATA_CENTER = '陸行鳥'

// Snapshot refreshed from Universalis /api/v2/data-centers on 2026-05-26.
export const MARKET_DATA_CENTERS: DataCenter[] = [

export default {
  ...
  "instructions": "以前使っていたブラウザーで工房のバックアップをダウンロードし、ここで読み込んでください。",
  "link": "「グリーナーの依頼」でバックアップをダウンロード",
  "choose": "バックアップファイルを選択",
  "historyLimit": "履歴は最新の20件のみ残します。",
  "summary": "履歴 {notes} 件 · お気に入り {favorites} 件 · 設定 {settings} 件",
  ...
  "errors": {
    ...
    "format": "「グリーナーの依頼」の工房 v1 バックアップを選択してください。秘伝書や単独のノートには対応していません。",
  ...
  recommended: {
    title: 'うさぎのオススメ',
    description: 'ジョブ名やアイテムレベルで、お目当てのセットを検索。ノートを編集するには、JSONを「ノート作業台」にコピーしてください。',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'はい！おすすめノートも自分に合わせて編集できます。ノートのJSONをコピーして「ノート作業台」に貼り付け、インポートしてください。アイテムの追加・削除、数量の変更、ほかのノートとの結合ができます。'
      },
      {

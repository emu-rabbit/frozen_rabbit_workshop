export default {
  ...
  faq: {
    ...
    footer: '還有其他疑問嗎？歡迎透過 GitHub 回報或來信聯繫：mausu2526{'@'}gmail.com'
  },
  sponsorModal: {
    title: '支持冷凍兔肉的工坊',
    description: '感謝您的支持！由於支付平台（PayPal/Stripe）在台灣有區域轉帳限制，建議台灣玩家優先使用「台灣地區（綠界）」進行贊助，海外玩家則可使用「全球地區（Ko-fi）」。如有任何問題，請聯繫：mausu2526{'@'}gmail.com',

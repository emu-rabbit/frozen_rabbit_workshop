export default {
  ...
  "instructions": "Use your original browser to download a Workshop backup, then return here to import it.",
  "link": "Download a backup from The Gleaner’s Commission",
  "choose": "Choose a backup file",
  "historyLimit": "Only the 20 newest history notes will be kept.",
  "summary": "{notes} history notes · {favorites} favorites · {settings} settings",
  "policy": "{conflicts} entries differ. Which copy should we keep?",
  "keep": "Keep data on this site",
  "backup": "Use backup data",
  "reloadWarning": "Unsaved edits and material allocations will be lost.",
  "import": "Import and reload",
  "dismiss": "Don't show again",
  "later": "Maybe later",
  "errors": {
    "invalid": "Incomplete or invalid data: {detail}. Nothing was imported. Please check the backup.",
    "format": "Choose a Workshop v1 backup from The Gleaner’s Commission. Tome and individual note files are not supported.",
  ...
  gameData: {
    ...
    reloadWarning: 'New game data has been downloaded and is ready to use. You can choose when to apply it.',
    updateReady: 'New game data update detected',

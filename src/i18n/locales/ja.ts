export default {
  ...
  marketSetupReminder: {
    ...
    description: 'マーケット価格は、選択したリージョンとデータセンターをもとに見積もられます。素材を準備する前に、遊んでいるサーバーに合った取得元か確認しておくのがおすすめです。',
    note: 'マーケットのリージョン、データセンター、コスト戦略は「工房の設定」から変更できます。',
    openSettings: '工房の設定を開く',
    later: 'あとで確認する'
  },
  changelog: {
    title: 'アップデート履歴',

...
<template>
  <section v-if="dataError || !catalogData || (pendingDataManifest && !updateDismissed)" aria-live="polite" class="mx-4 mt-4 space-y-2 text-sm" data-testid="game-data-status">
